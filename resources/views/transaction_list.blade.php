...
<thml>
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{ ('camp.html.css/css/transaction.list.css') }}">
    <title>取引中一覧</title>
  </head>
    ...
    <nav class="header_nav">
      ...
      <articre class="item_list_articre">
        <div class="item_img_left">
          <a href="/transaction"><img src="{{ asset('camp.html.css/img/camp_2.jpg') }}" class="item_img_size"></a>
        </div>
        <div class="item_ttl_right">
          <p class="item_ttl"><a class="item_ttl_a" href="/transaction">メスティン</a></p>
      ...
      <articre class="item_list_articre">
        ...
        <div class="item_ttl_right">
          <p class="item_ttl"><a class="item_ttl_a" href="transaction.html">焚き火台</a></p>
      ...
      <articre class="item_list_articre">
        ...
        <div class="item_ttl_right">
          <p class="item_ttl"><a class="item_ttl_a" href="transaction.html">マグカップ</a></p>
