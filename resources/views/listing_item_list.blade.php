...
<thml>
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{ ('camp.html.css/css/like.css') }}">
    <title>出品した商品</title>
  </head>
    ...
    <nav class="header_nav">
      ...
      <articre class="item_list_articre">
        <div class="item_img_left">
          <a href="/item"><img src="{{ ('camp.html.css/img/camp_5.jpg')}}" class="item_img_size"></a>
        </div>
        <div class="item_ttl_right">
          <p class="item_ttl"><a class="item_ttl_a" href=""></a></p>
